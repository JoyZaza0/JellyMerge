...
namespace Watermelon
{
    ...
    public class AdsDataEditor : Editor
    {
        ...
        protected void PrepareStyles()
        {
            ...
            testIdContent = new GUIContent(" test id", WatermelonEditor.Styles.GetIcon("icon_warning"), "You are using test app id value.");
            groupStyle = new GUIStyle(WatermelonEditor.Styles.label_medium);
        ...
        private class AdMobContainer : AdsContainer
        {
            ...
            {
                GUILayout.Space(8);
                EditorGUILayout.LabelField("App", WatermelonEditor.Styles.label_medium_bold);
            ...
            {
                GUILayout.Space(8);
                EditorGUILayout.LabelField("Ad Units", WatermelonEditor.Styles.label_medium_bold);
