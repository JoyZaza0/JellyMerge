...
namespace Watermelon
{
    ...
    public class AudioSettingsEditor : Editor
    {
        ...
        {
            addButtonContent = new GUIContent(WatermelonEditor.Styles.GetIcon("icon_add"));
            checkmarkButtonContent = new GUIContent(WatermelonEditor.Styles.GetIcon("icon_check"));
        ...
        private bool HandleDisplay(IEnumerable<SerializedProperty> parentProperty, bool isSound)
        {
            foreach (SerializedProperty property in parentProperty)
            {
                ...
                if (GUILayout.Button("X", WatermelonEditor.Styles.button_04_mini, GUILayout.Width(24), GUILayout.Height(18)))
                {
