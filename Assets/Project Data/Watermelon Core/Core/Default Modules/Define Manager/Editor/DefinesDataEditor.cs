...
namespace Watermelon
{
    ...
    public class DefinesSettingsEditor : Editor
    {
        ...
        {
            // Prepare styles
            addDefineButton = new GUIContent(EditorCustomStyles.ICON_SPACE + "Add Define", WatermelonEditor.Styles.GetIcon("icon_add"));
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (tempDefine != null)
            {
                ...
                if (GUILayout.Button("✓", WatermelonEditor.Styles.button_03_mini, GUILayout.Height(18), GUILayout.Width(18)))
                {
            ...
            if (GUILayout.Button(addDefineButton, WatermelonEditor.Styles.button_01, GUILayout.Width(120)))
            {
                if(tempDefine == null)
                {
            ...
            Rect compileRect = EditorGUILayout.BeginVertical(WatermelonEditor.Styles.Skin.box);
