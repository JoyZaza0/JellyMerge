...
namespace Watermelon
{
    ...
    public class ProjectInitSettingsEditor : Editor
    {
        ...
        private SerializedProperty coreInitModulesProperty;
        ...
        protected void OnEnable()
        {
            ...
            coreInitModulesProperty = serializedObject.FindProperty(CORE_MODULES_PROPERTY_NAME);
            coreModulesProperty = serializedObject.FindProperty(INIT_MODULES_PROPERTY_NAME);
        ...
        private void LoadEditorsList()
        {
            ...
            for (int i = 0; i < coreInitModulesProperty.arraySize; i++)
            {
                initModule = coreInitModulesProperty.GetArrayElementAtIndex(i);
            ...
            if (arrayProperty.arraySize > 0)
            {
                for (int i = 0; i < arrayProperty.arraySize; i++)
                {
                    ...
                    if (initModule.objectReferenceValue != null)
                    {
                        ...
                        EditorGUILayout.LabelField(EditorCustomStyles.ICON_SPACE + moduleNameProperty.stringValue, WatermelonEditor.Styles.label_medium);
        ...
        public override void OnInspectorGUI()
        {
            ...
            DrawInitModule(coreInitModulesProperty, "CORE MODULES", false);
            ...
            DrawInitModule(coreModulesProperty, "CUSTOM MODULES", true);
