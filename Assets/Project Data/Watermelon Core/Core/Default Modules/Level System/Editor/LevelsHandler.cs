...
namespace Watermelon
{
    public class LevelsHandler
    {
        ...
        {
            if (GUILayout.Button(RENAME_LEVELS_LABEL, WatermelonEditor.Styles.button_01))
            {
                RenameLevels();
            }
        }
        ...
        {
            if (GUILayout.Button(GLOBAL_VALIDATION_LABEL, WatermelonEditor.Styles.button_01))
            {
