...
namespace Watermelon
{
    ...
    sealed internal class PoolManagerEditor : Editor
    {
        ...
        private void PrepareStyles()
        {
            ...
            headerStyle = new GUIStyle(WatermelonEditor.Styles.Skin.label);
            headerStyle.normal.textColor = labelColor;
            headerStyle.alignment = TextAnchor.MiddleCenter;
            headerStyle.fontStyle = FontStyle.Bold;
            headerStyle.fontSize = 12;

            bigHeaderStyle = new GUIStyle(WatermelonEditor.Styles.Skin.label);
            ...
            centeredTextStyle = new GUIStyle(WatermelonEditor.Styles.Skin.label);
            ...
            Texture warningIconTexture = WatermelonEditor.Styles.GetIcon("icon_warning");// AssetDatabase.LoadAssetAtPath<Texture>(@"Assets\Project Name\Watermelon Core\Plugins\Editor\Resources\UI\Sprites\Icons\icon_warning.png");
            warningIconGUIContent = new GUIContent(warningIconTexture);


            Texture lockedTexture = WatermelonEditor.Styles.GetIcon("icon_locked"); // AssetDatabase.LoadAssetAtPath<Texture>(@"Assets\Project Name\Watermelon Core\Plugins\Editor\Resources\UI\Sprites\Icons\icon_locked.png");
            lockedIconGUIContent = new GUIContent(lockedTexture);

            Texture unlockedTexture = WatermelonEditor.Styles.GetIcon("icon_unlocked");//AssetDatabase.LoadAssetAtPath<Texture>(@"Assets\Project Name\Watermelon Core\Plugins\Editor\Resources\UI\Sprites\Icons\icon_unlocked.png");
