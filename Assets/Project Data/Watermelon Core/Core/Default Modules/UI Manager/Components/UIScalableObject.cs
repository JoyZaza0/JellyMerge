...
namespace Watermelon
{
    ...
    public class UIScalableObject
    {
        ...
        public void Show(float scaleMultiplier = 1.1f, float duration = 0.5f, bool immediately = false, SimpleCallback onCompleted = null)
        {
        ...
        public void Hide(float scaleMultiplier = 1.1f, float duration = 0.5f, bool immediately = false, SimpleCallback onCompleted = null)
        {
            scaleTweenCase.KillActive();
