...
namespace Watermelon
{
    public static class EditorGUILayoutCustom
    {
        ...
        public static Vector2 BeginScrollView(Vector2 scrollPosition)
        {
            ...
            GUI.skin = WatermelonEditor.Styles.Skin;

            Vector2 tempScrollPosition = EditorGUILayout.BeginScrollView(scrollPosition, WatermelonEditor.Styles.Skin.horizontalScrollbar, WatermelonEditor.Styles.Skin.verticalScrollbar);
        ...
        public static void DrawCompileWindow(Rect editorRect)
        {
            if (EditorApplication.isCompiling)
            {
                ...
                GUI.Box(rect, "Compiling..", WatermelonEditor.Styles.boxCompiling);
            }
        }
        ...
        public static bool HeaderToggle(string title, bool value)
        {
            ...
            EditorGUILayout.LabelField(title, WatermelonEditor.Styles.boxHeader, GUILayout.ExpandHeight(true), GUILayout.ExpandWidth(true));

            GUILayout.FlexibleSpace();

            EditorGUILayout.BeginVertical(GUILayout.ExpandHeight(true));
            GUILayout.FlexibleSpace();
            value = EditorGUILayout.Toggle(value, WatermelonEditor.Styles.Skin.toggle, GUILayout.Width(32), GUILayout.Height(21));
            GUILayout.FlexibleSpace();
        ...
        public static void HelpBox(string title, string buttonTitle = "", Action onClickAction = null)
        {
            ...
            EditorGUILayout.LabelField(title, WatermelonEditor.Styles.helpboxLabel, GUILayout.ExpandHeight(true));
