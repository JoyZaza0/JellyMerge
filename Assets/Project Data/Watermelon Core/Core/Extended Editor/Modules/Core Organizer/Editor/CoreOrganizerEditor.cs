    ...
    public class CoreOrganizerEditor : Editor
    {
        ...
        private void DrawElementCallback(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            if (currentElementProperty.isExpanded)
            {
                ...
                if (directoryProperty.stringValue.StartsWith("Assets/"))
                {
                    directoryProperty.stringValue = directoryProperty.stringValue.Substring(7);
        ...
        private void UpdateStatus()
        {
            ...
            bool exists = (Directory.Exists(globalDirectory) || File.Exists(globalDirectory));
